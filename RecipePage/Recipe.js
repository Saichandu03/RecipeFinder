...
var category_data = {
  "Biryani's": [
    0,
    "https://ruralkingz.com/wp-content/uploads/2020/08/fried.jpg",
  ],
  "Starter's": [1, "../assets/images/Categories/starters.jpeg"],
  "Dessert's": [2, "../assets/images/Categories/Desserts.jpg"],
  "Burger's": [
    3,
    "https://images.immediate.co.uk/production/volatile/sites/2/2021/05/Burger-fdbcbf4.jpg?quality=90&webp=true&resize=2200,1465",
  ],
  "Non-Veg": [
    4,
    "https://img.freepik.com/premium-photo/bowl-chicken-curry-with-green-white-rim_1239531-87.jpg?w=1380",
  ],
  StreetFood: [
    5,
    "https://img.freepik.com/free-photo/close-up-delicious-asian-food_23-2150535902.jpg?t=st=1722055934~exp=1722059534~hmac=93bc5380f11b95f9a06811371cb77f055e9bbc132c2c5c003ba13aed6ce9aecd&w=360",
  ],
  Pizza: [
    6,
    "https://img.freepik.com/premium-photo/margherita-pizza-with-mozzarella-cheese-bubbling_1194832-19275.jpg?w=996",
  ],
  "Veg Items": [
    7,
    "https://img.freepik.com/free-photo/high-angle-delicious-pakistan-dish-assortment_23-2148821527.jpg?t=st=1722056396~exp=1722059996~hmac=3de8c6d0b58a4000812b7dea90ffc11f1dd1d63299a6b672cf6f25cc224775ca&w=996",
  ],
  Salads: [
    8,
    "https://img.freepik.com/free-photo/side-view-salad-herring-fur-coat-with-tomatoes-radishes_140725-13979.jpg?t=st=1722057296~exp=1722060896~hmac=2f6b9c5b5299de15a1948468f63ffe54848422cb7216b3b055bd4e5acbcbc208&w=740",
  ],
  Pickles: [
    9,
    "https://www.farmdidi.com/cdn/shop/articles/Blog-post-revised.webp?v=1670659916",
  ],
  HomeMakes: [
    10,
  ...
  Tiffins: [
    11,
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIaNjL9IM8PgmxHk-F14IjTyB-yZyDPSJF0wkXtQ5k09IgZsFUBFL-VlMgmb4EyMvnKxY&usqp=CAU",
  ],
};
...
const createItem = (ele) => {
  ...
  button.addEventListener("click", function () {
    ...
    location.href =
      "../RecipeViewPageOverAll/RecipeViewPage/RecipeViewPage.html";
  });
...
const openn = () => {
  ...
  if (
    open1 == false &&
    ((localStorage.getItem("user") === "nryadav" &&
      localStorage.getItem("pass") === "Nryadav@123") ||
      (localStorage.getItem("user") === "saichandu" &&
        localStorage.getItem("pass") === "Saichandu@123") ||
      (localStorage.getItem("user") === "mani" &&
        localStorage.getItem("pass") === "Mani@123") ||
      (localStorage.getItem("user") === "deepthi" &&
        localStorage.getItem("pass") === "Deepthi@123") ||
      (localStorage.getItem("user") === "chandu" &&
        localStorage.getItem("pass") === "Chandu@123") ||
      (localStorage.getItem("user") === "abhiram" &&
        localStorage.getItem("pass") === "Abhiram@123"))
  ) {
    open1 = true;
    cont.style.scale = 1;
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    if (isNaN(stars) || stars < 1 || stars > 5) {
      document.getElementById("starsError").textContent =
    ...
    if (valid) {
      ...
      function setCookie(name, value, days) {
        ...
        document.cookie =
          name + "=" + encodeURIComponent(jsonStr) + ";" + expires + ";path=/";
